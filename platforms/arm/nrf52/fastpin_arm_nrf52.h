...
// Use struct defined in NRF52 Arduino Board Package. No need to recreate here.
...
//} FL_NRF_GPIO_Type;
//
//#define FL_NRF_GPIO_BASE                   0x50000500UL	//NRF52832 GPIO Base is 0x500000500UL, not 0x500000504UL.
//#define FL_NRF_GPIO                        ((FL_NRF_GPIO_Type           *) FL_NRF_GPIO_BASE)	// Use NRF_P0 (NRF_GPIO depreciated in Nordic SDK 15). NRF_P0 already defined in BSP.
...
public:
  ...
  inline static void setOutput() { NRF_P0->DIRSET = _MASK; }
  inline static void setInput() { NRF_P0->DIRCLR = _MASK; }

  inline static void hi() __attribute__ ((always_inline)) { NRF_P0->OUTSET = _MASK; }
  inline static void lo() __attribute__ ((always_inline)) { NRF_P0->OUTCLR= _MASK; }
  inline static void set(register port_t val) __attribute__ ((always_inline)) { NRF_P0->OUT = val; }

  inline static void strobe() __attribute__ ((always_inline)) { toggle(); toggle(); }

  inline static void toggle() __attribute__ ((always_inline)) { NRF_P0->OUT ^= _MASK; }

  inline static void hi(register port_ptr_t port) __attribute__ ((always_inline)) { hi(); }
  inline static void lo(register port_ptr_t port) __attribute__ ((always_inline)) { lo(); }
  inline static void fastset(register port_ptr_t port, register port_t val) __attribute__ ((always_inline)) { *port = val; }

  inline static port_t hival() __attribute__ ((always_inline)) { return NRF_P0->OUT | _MASK; }
  inline static port_t loval() __attribute__ ((always_inline)) { return NRF_P0->OUT & ~_MASK; }
  inline static port_ptr_t port() __attribute__ ((always_inline)) { return &NRF_P0->OUT; }
  inline static port_t mask() __attribute__ ((always_inline)) { return _MASK; }

  inline static bool isset() __attribute__ ((always_inline)) { return (NRF_P0->IN & _MASK) != 0; }
};
